...
<head>
  ...
  <style>
    ...
    * {
    ...
    :root {
      /* Default Theme: Green - Khas MARHAS */
    ...
    body.theme-blue {
      ...
      --green-dark: #1d4ed8;
      --green-darker: #1e3a8a;
      --green-lightest: #dbeafe;
    }

    /* Theme: Orange - Teknik Pemesinan */
    body.theme-orange {
