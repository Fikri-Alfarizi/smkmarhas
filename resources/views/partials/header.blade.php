<header class="top-bar">
  ...
  <div class="top-social">
    ...
    <div class="theme-switcher">
      ...
      <div class="theme-btn theme-btn-blue" data-theme="blue" title="Biru (PPLG)"></div>
      <div class="theme-btn theme-btn-orange" data-theme="orange" title="Orange (Mesin)"></div>
    </div>
  ...
  <div class="mobile-nav-links">
    ...
    <div style="padding: 10px; margin-bottom: 10px; border-bottom: 1px solid #eee;">
      ...
      <div class="theme-switcher" style="justify-content: flex-start;">
        <div class="theme-btn theme-btn-green active" data-theme="green" title="Hijau"></div>
        <div class="theme-btn theme-btn-blue" data-theme="blue" title="Biru"></div>
        <div class="theme-btn theme-btn-orange" data-theme="orange" title="Orange"></div>
      </div>
    </div>
