        ...
        <div class="footer-content">
          <div>
            ...
            <div class="footer-social">
              ...
              <a href="https://web.facebook.com/marhas.bisa.9" title="Facebook" target="_blank"
          ...
          <div>
            ...
            <ul class="footer-list">
              <li><i class="fas fa-chevron-right"></i> <a href="#">Teknik Pemesinan</a></li>
              <li><i class="fas fa-chevron-right"></i> <a href="#">Rekayasa Perangkat Lunak</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="footer-list">
              <li><i class="fas fa-chevron-right"></i> <a href="#">Profil Sekolah</a></li>
              <li><i class="fas fa-chevron-right"></i> <a href="#">Info SPMB</a></li>
              <li><i class="fas fa-chevron-right"></i> <a href="#">Kontak Kami</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="footer-list">
              <li>
                ...
                <span style="color: #aaa; font-size: 14px;">Jl. Terusan Kopo No.385/299, Margahayu, Kab. Bandung</span>
              </li>
              <li>
                <i class="fas fa-phone"></i>
                <a href="tel:+62221234567">(022) 5410926</a>
              </li>
              <li>
